// $ANTLR 2.7.7 (2006-11-01): "../src/main/java/cn/devezhao/persist4j/query/compiler/antlr/ajql.g" -> "AjQLLexer.java"$
...
public AjQLLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("concat", this), new Integer(31));
	...
	literals.put(new ANTLRHashString("match", this), new Integer(41));
	...
	literals.put(new ANTLRHashString("between", this), new Integer(38));
	...
	literals.put(new ANTLRHashString("like", this), new Integer(36));
	literals.put(new ANTLRHashString("date", this), new Integer(30));
	literals.put(new ANTLRHashString("group_concat", this), new Integer(42));
	literals.put(new ANTLRHashString("week", this), new Integer(27));
	literals.put(new ANTLRHashString("separator", this), new Integer(43));
