...
public class AjQLParser extends antlr.LLkParser implements AjQLParserTokenTypes {
	...
	public final void column() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			if ((LA(1) == IDENT) && (_tokenSet_11.member(LA(2)))) {
				dbObject();
				astFactory.addASTChild(currentAST, returnAST);
	...
	public final void subSimpleCondition() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			{
				if ((LA(1) == NOT) && (_tokenSet_19.member(LA(2)))) {
					AST tmp53_AST = null;
	...
	public final void simplePredicate() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			{
				if ((_tokenSet_12.member(LA(1))) && (_tokenSet_23.member(LA(2)))) {
					expression();
					astFactory.addASTChild(currentAST, returnAST);
	...
	public final void subExpression() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			...
			}
			{
				...
				default:
					if ((_tokenSet_25.member(LA(1))) && (_tokenSet_16.member(LA(2)))) {
						constant();
						astFactory.addASTChild(currentAST, returnAST);
					} else if ((_tokenSet_26.member(LA(1))) && (LA(2) == AND)) {
						constantSimple();
						astFactory.addASTChild(currentAST, returnAST);
						AST tmp85_AST = null;
	...
	public static final String[] _tokenNames = { "<0>", "EOF", "<2>", "NULL_TREE_LOOKAHEAD", "\"select\"",
			...
			"\"count\"", "\"date_format\"", "\"year\"", "\"quarter\"", "\"month\"", "\"week\"", "\"date\"",
			"\"concat\"", "\"is\"", "\"not\"", "\"null\"", "\"in\"", "\"like\"", "\"exists\"", "\"between\"",
			"\"true\"", "\"false\"", "\"match\"", "COMMA", "IDENT", "LPAREN", "RPAREN", "QUOTED_STRING", "STAR",
			"LITERAL", "NAMED_PARAM", "QUESTION_MARK", "PLUS", "MINUS", "DIVIDE", "MOD", "EQ", "LT", "GT", "LE", "GE",
			"SQL_NE", "BAND", "NBAND", "DOT", "COLON", "IDENT_START", "IDENT_LETTER", "DIGIT", "INT", "NUM", "ESCqs",
			"WS" };
	...
	private static final long[] mk_tokenSet_8() {
		long[] data = { 2305325786703445954L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_10() {
		long[] data = { 2296846353029929026L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_11() {
		long[] data = { 2296846353030028354L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_12() {
		long[] data = { 2206036937146368L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_13() {
		long[] data = { 2305842973780319570L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_14() {
		long[] data = { 8479433673408512L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_15() {
		long[] data = { 2296846353030037314L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_16() {
		long[] data = { 2305325786703445826L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_17() {
		long[] data = { 2206038010626048L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_18() {
		long[] data = { 9006516354941200L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_19() {
		long[] data = { 2206074517848064L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_20() {
		long[] data = { 2305841909701879570L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_21() {
		long[] data = { 2305841908628399890L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_23() {
		long[] data = { 9005416843388690L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_24() {
		long[] data = { 2305833078175564048L, 0L };
		return data;
	}
